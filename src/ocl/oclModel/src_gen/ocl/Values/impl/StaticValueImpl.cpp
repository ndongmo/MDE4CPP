...
{
	std::shared_ptr<StaticValueImpl> element(new StaticValueImpl(*this));
...
void StaticValueImpl::resolveReferences(const int featureID, std::list<std::shared_ptr<ecore::EObject> > references)
{
