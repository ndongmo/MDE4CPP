...
{
	std::shared_ptr<RealLiteralExpEvalImpl> element(new RealLiteralExpEvalImpl(*this));
...
void RealLiteralExpEvalImpl::resolveReferences(const int featureID, std::list<std::shared_ptr<ecore::EObject> > references)
{
