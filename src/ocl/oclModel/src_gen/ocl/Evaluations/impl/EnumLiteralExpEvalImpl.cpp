...
{
	std::shared_ptr<EnumLiteralExpEvalImpl> element(new EnumLiteralExpEvalImpl(*this));
...
void EnumLiteralExpEvalImpl::resolveReferences(const int featureID, std::list<std::shared_ptr<ecore::EObject> > references)
{
