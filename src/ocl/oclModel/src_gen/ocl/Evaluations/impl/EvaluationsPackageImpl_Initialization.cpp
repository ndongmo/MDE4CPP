...
void EvaluationsPackageImpl::initializeEvalEnvironmentContent()
{
	...
	m_evalEnvironment_Operation_add_NameValueBinding->setEType(nullptr);
	...
	m_evalEnvironment_Operation_addAll_NameValueBinding->setEType(nullptr);
	...
	m_evalEnvironment_Operation_replace_NameValueBinding->setEType(nullptr);
