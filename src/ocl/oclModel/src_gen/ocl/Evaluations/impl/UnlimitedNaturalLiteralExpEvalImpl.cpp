...
{
	std::shared_ptr<UnlimitedNaturalLiteralExpEvalImpl> element(new UnlimitedNaturalLiteralExpEvalImpl(*this));
...
void UnlimitedNaturalLiteralExpEvalImpl::resolveReferences(const int featureID, std::list<std::shared_ptr<ecore::EObject> > references)
{
