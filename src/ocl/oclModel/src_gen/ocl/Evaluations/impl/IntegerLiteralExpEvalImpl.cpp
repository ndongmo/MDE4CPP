...
{
	std::shared_ptr<IntegerLiteralExpEvalImpl> element(new IntegerLiteralExpEvalImpl(*this));
...
void IntegerLiteralExpEvalImpl::resolveReferences(const int featureID, std::list<std::shared_ptr<ecore::EObject> > references)
{
