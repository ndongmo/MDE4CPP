...
namespace ocl::Types 
{
	class TypesFactory : virtual public ecore::EFactory 
	{
		...
		protected:
			...
			virtual std::shared_ptr<ocl::Types::AnyType> createAnyType_in_EContainer(std::weak_ptr<ecore::EObject > par_eContainer, const int metaElementID = TypesPackage::ANYTYPE_CLASS) const = 0;
			//Add containing object
			...
			//Add containing object
			virtual std::shared_ptr<ocl::Types::BagType> createBagType_in_EContainer(std::weak_ptr<ecore::EObject > par_eContainer, const int metaElementID = TypesPackage::BAGTYPE_CLASS) const = 0;
			//Add containing object
			...
			//Add containing object
			virtual std::shared_ptr<ocl::Types::CollectionType> createCollectionType_in_EContainer(std::weak_ptr<ecore::EObject > par_eContainer, const int metaElementID = TypesPackage::COLLECTIONTYPE_CLASS) const = 0;
			//Add containing object
			...
			//Add containing object
			virtual std::shared_ptr<ocl::Types::InvalidType> createInvalidType_in_EContainer(std::weak_ptr<ecore::EObject > par_eContainer, const int metaElementID = TypesPackage::INVALIDTYPE_CLASS) const = 0;
			//Add containing object
			...
			//Add containing object
			virtual std::shared_ptr<ocl::Types::MessageType> createMessageType_in_EContainer(std::weak_ptr<ecore::EObject > par_eContainer, const int metaElementID = TypesPackage::MESSAGETYPE_CLASS) const = 0;
			//Add containing object
			...
			//Add containing object
			virtual std::shared_ptr<ocl::Types::OrderedSetType> createOrderedSetType_in_EContainer(std::weak_ptr<ecore::EObject > par_eContainer, const int metaElementID = TypesPackage::ORDEREDSETTYPE_CLASS) const = 0;
			//Add containing object
			...
			//Add containing object
			virtual std::shared_ptr<ocl::Types::SequenceType> createSequenceType_in_EContainer(std::weak_ptr<ecore::EObject > par_eContainer, const int metaElementID = TypesPackage::SEQUENCETYPE_CLASS) const = 0;
			//Add containing object
			...
			//Add containing object
			virtual std::shared_ptr<ocl::Types::SetType> createSetType_in_EContainer(std::weak_ptr<ecore::EObject > par_eContainer, const int metaElementID = TypesPackage::SETTYPE_CLASS) const = 0;
			//Add containing object
			...
			//Add containing object
			virtual std::shared_ptr<ocl::Types::TemplateParameterType> createTemplateParameterType_in_EContainer(std::weak_ptr<ecore::EObject > par_eContainer, const int metaElementID = TypesPackage::TEMPLATEPARAMETERTYPE_CLASS) const = 0;
			//Add containing object
			...
			//Add containing object
			virtual std::shared_ptr<ocl::Types::TupleType> createTupleType_in_EContainer(std::weak_ptr<ecore::EObject > par_eContainer, const int metaElementID = TypesPackage::TUPLETYPE_CLASS) const = 0;
			//Add containing object
			...
			//Add containing object
			virtual std::shared_ptr<ocl::Types::VoidType> createVoidType_in_EContainer(std::weak_ptr<ecore::EObject > par_eContainer, const int metaElementID = TypesPackage::VOIDTYPE_CLASS) const = 0;
			//Add containing object
