...
//Additional constructor for the containments back reference
PropertyCallExpImpl::PropertyCallExpImpl(std::weak_ptr<ecore::EObject > par_eContainer)
:PropertyCallExpImpl()
{
...
{
	std::shared_ptr<PropertyCallExpImpl> element(new PropertyCallExpImpl(*this));
...
// Union Getter
//*********************************
std::shared_ptr<Union<ecore::EObject>> PropertyCallExpImpl::getEContens() const
{
...
Any PropertyCallExpImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::PROPERTYCALLEXP_ATTRIBUTE_REFERREDPROPERTY:
			return eAny(std::dynamic_pointer_cast<ecore::EObject>(getReferredProperty())); //7129
	}
...
bool PropertyCallExpImpl::internalEIsSet(int featureID) const
{
	...
	{
		case ocl::Expressions::ExpressionsPackage::PROPERTYCALLEXP_ATTRIBUTE_REFERREDPROPERTY:
			return getReferredProperty() != nullptr; //7129
	}
...
bool PropertyCallExpImpl::eSet(int featureID, Any newValue)
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::PROPERTYCALLEXP_ATTRIBUTE_REFERREDPROPERTY:
		{
			...
			setReferredProperty(_referredProperty); //7129
			return true;
		}
	}
...
void PropertyCallExpImpl::resolveReferences(const int featureID, std::list<std::shared_ptr<ecore::EObject> > references)
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::PROPERTYCALLEXP_ATTRIBUTE_REFERREDPROPERTY:
...
void PropertyCallExpImpl::saveContent(std::shared_ptr<persistence::interfaces::XSaveHandler> saveHandler) const
{
	try
	{
		...
		// Add references
		saveHandler->addReference("referredProperty", this->getReferredProperty());
