...
//Additional constructor for the containments back reference
			BooleanLiteralExpImpl::BooleanLiteralExpImpl(std::weak_ptr<ecore::EObject > par_eContainer)
			:BooleanLiteralExpImpl()
			{
...
{
	std::shared_ptr<BooleanLiteralExpImpl> element(new BooleanLiteralExpImpl(*this));
...
// Union Getter
//*********************************
std::shared_ptr<Union<ecore::EObject>> BooleanLiteralExpImpl::getEContens() const
{
	return m_eContens;
}
...
Any BooleanLiteralExpImpl::eGet(int featureID, bool resolve, bool coreType) const
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::BOOLEANLITERALEXP_ATTRIBUTE_BOOLEANSYMBOL:
			return eAny(getBooleanSymbol()); //826
	}
...
bool BooleanLiteralExpImpl::internalEIsSet(int featureID) const
{
	...
	{
		case ocl::Expressions::ExpressionsPackage::BOOLEANLITERALEXP_ATTRIBUTE_BOOLEANSYMBOL:
			return getBooleanSymbol() != false; //826
	}
...
bool BooleanLiteralExpImpl::eSet(int featureID, Any newValue)
{
	switch(featureID)
	{
		case ocl::Expressions::ExpressionsPackage::BOOLEANLITERALEXP_ATTRIBUTE_BOOLEANSYMBOL:
		{
			...
			setBooleanSymbol(_booleanSymbol); //826
			return true;
		}
	}
...
void BooleanLiteralExpImpl::resolveReferences(const int featureID, std::list<std::shared_ptr<ecore::EObject> > references)
{
