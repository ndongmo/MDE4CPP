...
{
	std::shared_ptr<PrimitiveLiteralExpImpl> element(new PrimitiveLiteralExpImpl(*this));
...
void PrimitiveLiteralExpImpl::resolveReferences(const int featureID, std::list<std::shared_ptr<ecore::EObject> > references)
{
